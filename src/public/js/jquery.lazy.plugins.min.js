...
!(function (t) {
  ...
  (function (t) {
    t.lazy(['frame', 'iframe'], 'iframe', function (a, e) {
      ...
      if ('iframe' === a[0].tagName.toLowerCase()) {
        ...
        'true' !== o && '1' !== o
          ? (a.attr('src', a.attr('data-src')), r.config('removeAttribute') && a.removeAttr('data-src data-error-detect'))
          : t.ajax({
              url: a.attr('data-src'),
              dataType: 'html',
              crossDomain: !0,
      ...
      if ('picture' === i[0].tagName.toLowerCase()) {
        ...
        c.length
          ...
          ? (t('<source>')
              ...
              .appendTo(i),
            e(i, d + i.attr(o), n),
            this.config('removeAttribute') && i.removeAttr(o + ' data-srcset data-media data-sizes data-type'))
          : n(!1);
      } else n(!1);
    });
  })(window.jQuery || window.Zepto),
  (function (t) {
    t.lazy(['js', 'javascript', 'script'], 'script', function (t, a) {
      'script' === t[0].tagName.toLowerCase()
        ? (t.attr('src', t.attr('data-src')), this.config('removeAttribute') && t.removeAttr('data-src'))
        : a(!1);
    });
  })(window.jQuery || window.Zepto),
  (function (t) {
  ...
  (function (t) {
    t.lazy(['yt', 'youtube'], function (t, a) {
      'iframe' === t[0].tagName.toLowerCase()
        ? (t.attr('src', 'https://www.youtube.com/embed/' + t.attr('data-src') + '?rel=0&amp;showinfo=0'),
          this.config('removeAttribute') && t.removeAttr('data-src'))
        : a(!1);
    });
  })(window.jQuery || window.Zepto);
